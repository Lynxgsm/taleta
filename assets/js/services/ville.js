angular.module('villeFactory', []).factory('villeFactory', function ($rootScope, $http) {
    var urlBase = "./API/ville";
    ...
    dataFactory.getByPays = function (id) {
        var url = urlBase + "/getByPays?id=" + id;
        return $http.get(url);
    }
